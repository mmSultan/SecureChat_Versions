...
public class FileServices {
    ...
    // save chat that received from client at the end of a session
    ...
    // function that returns all the history file names for a particuler client to be send when is requested. 
    public File[] getFile(String clientID){
        File folder = new File("c:\\Secure Chat\\History\\"+clientID);
    ...
    // function that reads info.txt file that contains the server port 
    ...
    // save received files from clients.
