...
public class Queue {
   ...
   public static HashMap <String,PublicKey> publikKeysList = new HashMap<>();
...
//} 
   ...
   MainForm.fileSocketList.setListData(fileSocketList.entrySet().toArray());
    ...
    public static void addPublikKeysList (String clientID,PublicKey key){
    publikKeysList.put(clientID, key);
        System.out.println(clientID+" Key: " +key+" added");
   }
   public static void removePublikKeysList (String clientID){
    publikKeysList.remove(clientID);
    System.out.println(clientID+" Key removed");
   }
