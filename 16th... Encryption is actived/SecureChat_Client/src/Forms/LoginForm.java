...
public class LoginForm extends javax.swing.JFrame {
    ...
    public LoginForm() {
        initComponents();
        rsa = new RSA();
        rsa.generateKey(); // create public and private keys
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(210, 310, 100, 30);

        userText.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       // String clientID ="A "+ rnd.nextInt(1000);
        ...
        sendPkt.setPublicKey(rsa.getMyPublicKey());
