     ...
     Packet rcvPkt;
        ...
        try {
            ...
            switch (rcvPkt.getType()){
                ...
                case 2: //DATA packet
                    appendToPane(chatText2,MainForm.tempList.get(rcvPkt.getData2())+":"+
                            rcvPkt.getData1()+"\n",Color.black);
                ...
                case 5:
                    if(rcvPkt.isAddToList()){ // true means add to list
                     ...
                     appendToPane(chatText2,MainForm.tempList.get(rcvPkt.getData1())+" has been invited by..."+rcvPkt.getData2()+"\n",Color.blue);
                     System.out.println(Info.getClientID()+" Local rcvd pkt-5");
                        ...
                        if(!rcvPkt.getData1().equals(Info.getClientID())){// removed user is not me
                            ...
                            appendToPane(chatText2,MainForm.tempList.get(rcvPkt.getData1())+" has been removed by..."+rcvPkt.getData2()+"\n",Color.red);
